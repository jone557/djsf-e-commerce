...
const Navbar = () => {
    ...
    const changeBackground = () => {
        ...
        else if (pathname === '/search-products' || pathname === '/profile' || pathname === '/lip-products' || pathname.indexOf('/orderSummary') !== -1 || pathname === '/orders' || pathname === '/product details' || pathname === '/orderSuccess' || pathname.indexOf('/products') !== -1 || pathname === '/my-wish-list' || pathname === '/cart' || pathname === '/aboutUs') {
            setNavbar(true);
        }
                    ...
                    <div className="links-controller">
                        ...
                        <div className={sideNavbar ? "sideNavbar active" : "sideNavbar"}>
                            <ul className="nav-menu-items" onClick={manageSideNavbar} onMouseLeave={manageSideNavbar} >
                                ...
                                <li className="nav-text">
                                    <a href="/order" className={classes.links}>
                                        Order
                                    </a>
                                </li>
                                <li className="nav-text">
