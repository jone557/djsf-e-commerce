            ...
            <div className="Brushes">
                {
                    BrushContent.map((Brush) => {
                        return (
                            ...
                            <div key={Brush.id} style={{ backgroundImage: `url(http://localhost:5000/images/uploads/${Brush.img}` }} className={`Brush ${Brush.clName1} ${Brush.clName2}`}>
                                <div className='brush-product-details'>
                                    ...
                                    <div className="Brush-icons">
                                        <Button variant="p" size="small" style={{ textTransform: "capitalize" }} onClick={() => {
                                            const _id = Brush.id;
                                            ...
                                            // history.push(`/cart`);
                                        }} disableElevation className="button" >Add to Cart</Button>
                                        <IconButton style={{ width: '35%', margin: 'auto', color: 'rgb(240, 239, 234)' }} onClick={AddtoFavorite(Brush.id)}>
                                            <Favorite />
                                        </IconButton>
                                    </div>
                                </div>
