...
export const getLip = (id) => async (dispatch) =>{
    ...
    try {
        const {data} = await axios.get(`http://localhost:5000/api/v1/products/lip-products/${id}`)
        console.log(data)
...
export const getEye = (id) => async (dispatch) =>{
    ...
    try {
        const {data} = await axios.get(`http://localhost:5000/api/v1//products/eye-products/${id}`)
        console.log(data)
